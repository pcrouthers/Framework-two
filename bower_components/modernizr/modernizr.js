/*!
 * modernizr v3.2.0
 * Build http://modernizr.com/download?-adownload-animation-appearance-audioloop-audiopreload-backdropfilter-backgroundcliptext-canvasblending-canvastext-canvaswinding-contenteditable-contextmenu-cookies-cors-cryptography-cssall-cssanimations-customevent-customprotocolhandler-dart-dataview-emoji-eventlistener-exiforientation-flash-forcetouch-fullscreen-gamepads-geolocation-getrandomvalues-hashchange-hiddenscroll-history-htmlimports-ie8compat-indexeddb-indexeddbblob-input-inputtypes-intl-json-ligatures-lowbattery-mathml-notification-olreversed-pagevisibility-performance-pointerevents-pointerlock-postmessage-proximity-queryselector-quotamanagement-requestanimationframe-search-serviceworker-svg-templatestrings-todataurljpeg_todataurlpng_todataurlwebp-touchevents-typedarrays-unicode-unicoderange-userdata-vibrate-video-vml-webaudio-webgl-webintents-websockets-xdomainrequest-setclasses-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
